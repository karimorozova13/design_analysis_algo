...
# value = trie.get("apple")  # Повертає значення, якщо слово "apple" існує
# is_present = trie.contains("apple")  # Повертає True, якщо слово "apple" є у Trie

# trie.put("app", 2)
# prefix = trie.longest_prefix_of("applause")  # Поверне "app"
# trie.put("apple", 1)
# keys_with_prefix = trie.keys_with_prefix("app")
# keys = trie.keys()
